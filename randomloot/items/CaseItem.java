...
public class CaseItem extends ItemBase {
	...
	public static ItemStack getItem(World worldIn, EntityLivingBase player, Item i) {
		...
		if (iChoice.equals(ModItems.RL_SWORD)) {
			...
			switch (rarity) {
			case 1:
				pick.setDigSpeed(7 + rand.nextInt(6));
				break;
			case 2:
				pick.setDigSpeed(13 + rand.nextInt(5));
				break;
			case 3:
				pick.setDigSpeed(18 + rand.nextInt(5));
				break;
			...
			switch (rarity) {
			case 1:
				shov.setDigSpeed(7 + rand.nextInt(6));
				break;
			case 2:
				shov.setDigSpeed(13 + rand.nextInt(5));
				break;
			case 3:
				shov.setDigSpeed(18 + rand.nextInt(5));
				break;
			...
			switch (rarity) {
			case 1:
				axe.setDigSpeed(7 + rand.nextInt(6));
				break;
			case 2:
				axe.setDigSpeed(13 + rand.nextInt(5));
				break;
			case 3:
				axe.setDigSpeed(18 + rand.nextInt(5));
				break;
			...
			switch (rarity) {
			case 1:
				bow.setVelo(max / 100 * 2 + rand.nextInt(max / 100 * 20));
				break;
			case 2:
				bow.setVelo(max / 100 * 30 + rand.nextInt(max / 100 * 20));
				break;
			case 3:
				bow.setVelo(max / 100 * 50 + rand.nextInt(max / 100 * 40));
				break;

			}
			System.out.println(bow.getVelo());
			compound.setInteger("velo", bow.getVelo());
