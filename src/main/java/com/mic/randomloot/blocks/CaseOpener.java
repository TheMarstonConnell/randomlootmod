...
public class CaseOpener extends BlockContainer {

	public CaseOpener(String name) {
		super(Material.IRON);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof OpenerTileEntity) {
				((OpenerTileEntity) tileentity).setCustomName(stack.getDisplayName());
			}
		}
	}
