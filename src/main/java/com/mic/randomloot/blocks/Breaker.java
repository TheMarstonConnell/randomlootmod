...
public class Breaker extends BlockContainer
{
    ...
    {
        return Item.getItemFromBlock(ModBlocks.BREAKER);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        keepInventory = true;
            ...
            worldIn.setBlockState(pos, ModBlocks.BREAKER.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.BREAKER.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityBreaker)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityBreaker)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityBreaker)tileentity);
    ...
    {
        return new ItemStack(ModBlocks.BREAKER);
    }
