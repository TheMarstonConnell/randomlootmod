...
public class ThrowableRender extends EntityRenderer<ThrowableWeaponEntity> {
	...
	protected int getBlockLight(ThrowableWeaponEntity entityIn, BlockPos partialTicks) {
		return 15;
	}

	public void render(ThrowableWeaponEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
