...
public class RLAnvilScreen extends ContainerScreen<RLRepairContainer> implements IContainerListener{
	   private static final ResourceLocation TEXTURE = new ResourceLocation(RandomLootMod.MODID, "textures/gui/editor.png");

	   public RLAnvilScreen(RLRepairContainer p_i232291_1_, PlayerInventory p_i232291_2_, ITextComponent p_i232291_3_) {
